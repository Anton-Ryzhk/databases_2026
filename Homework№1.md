...
# 4. Частые запросы
### 1. Личный кабинет студента: «Мои активные курсы»

**Описание:** Запрос получает список всех курсов, на которые записан текущий авторизованный студент.
### 2. Витрина платформы: «Каталог курсов с сортировкой по популярности и рейтингу»

**Описание:** Запрос формирует список всех опубликованных курсов для главной страницы или раздела поиска.
### 3. Страница курса: «Учебный план (Syllabus) и лента отзывов»

**Описание:** Запрос извлекает детальную информацию по одному конкретному курсу, к которому перешел пользователь.
### 4. Плеер / Просмотр урока: «Проверка прав доступа и получение контента»

**Описание:** Запрос проверяет, имеет ли конкретный пользователь право смотреть конкретный урок, и возвращает ссылку на медиафайл.
### 5. Дашборд преподавателя: «Финансовая статистика и успехи студентов»

**Описание:** Запрос суммирует бизнес-показатели по всем курсам, созданным конкретным преподавателем.
